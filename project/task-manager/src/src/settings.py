...
AUTH_APP_ID = 'dP6nNoCwTzLj5RWeWX1cgKD06T6k9UwvfyTE3pEc'
AUTH_APP_SECRET = 'oXX9BbvBtEYZ9kpLFtUq7FWt9aifYkAOLJUkvjA2GAkVj7zUtqjdxH1DjUpkwHDzxQ6jSX5Nu2Q6oUkIWb47PwisosYDLYr1vMUjLv8HGdDkwBVYMkstHFNEL4qY3P3t'
AUTH_APP_GET_CURRENT_USER_URL = 'http://auth:8000/users/current/'
AUTH_APP_LOGIN_FORM_URL = 'http://localhost:8000/users/login/'
